package com.example.moviz.fragments
 ...
 * Use the [Hollywood_fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Hollywood_fragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    val database by lazy{
        FirebaseFirestore.getInstance().collection("hollywood")
    }
...
//                Toast.makeText(this,"welcome",Toast.LENGTH_LONG).show()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_hollywood_fragment, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        hollywood_frame_rv.adapter=My_Mov_Adapter
        val linearlayout=LinearLayoutManager(requireContext())
        linearlayout.orientation=LinearLayoutManager.HORIZONTAL
        hollywood_frame_rv.layoutManager=linearlayout
    ...
    companion object {
         ...
         * @return A new instance of fragment Hollywood_fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Hollywood_fragment().apply {
